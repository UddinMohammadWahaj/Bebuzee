...
class ProfileApiCalls {
  ...
  static Future<AllFeeds> getPosts(
    ...
    try {
      // var url = Uri.parse(
      //     "https://www.bebuzee.com/new_files/all_apis/member_profile_api_call.php?action=member_profile_post_data&user_id=$currentId&country=${CurrentUser().currentUser.country}&current_user_id=$currentId&post_ids=");
  ...
  static Future<PersonalBlogs> getBlogs(int page, String currentId) async {
    // var url = Uri.parse(
    //     "https://www.bebuzee.com/new_files/all_apis/blog_data_api_call.php?action=personal_blog_data&user_id=$currentId&profile_user_id=$currentId&page=$page");
...
// return AllFeeds([]);
  ...
  static Future<UserHighlightsList> getUserHighlights(
    ...
    try {
      // var url = Uri.parse(
      //     "https://www.bebuzee.com/app_devlope_heighlight_data.php?action=get_highlight_data&user_id=$memberID&country=${CurrentUser().currentUser.country}"
      //     );
