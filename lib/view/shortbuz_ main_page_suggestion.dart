...
class _ShortbuzMainPageSuggestionState extends State<ShortbuzMainPageSuggestion>
  ...
  Future<void> getVideos() async {
    ...
    var url =
        "https://www.bebuzee.com/api/shortbuz/shortbuzSuggested?action=short_video_data&user_id=${CurrentUser().currentUser.memberID}&post_id_from_feed=$postID&ip=$_internalIP&post_ids=&index=&data_sequence=&country=${CurrentUser().currentUser.country}&hashtag=${widget.from != null && widget.from != "disco" ? widget.from : ""}";
    print(url);
