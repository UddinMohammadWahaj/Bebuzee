...
class _HomePage extends State<HomePage>
  ...
  Widget _buildOffstageNavigator(String tabItem) {
    ...
    // );
    print(
        '${_navigatorKeys[tabItem]} $tabItem $_currentPage navigator key item');
    return Offstage(
                                    ...
                                    onTap: (int index) {
                                      ...
                                      if (pageKeys[index] == "Feeds") {
                                        ...
                                        setState(() {
                                          ...
                                          "Buzzfeed") {
                                        _selectTab("Buzzfeed", 4);
                                      } else if (pageKeys[index] == "Profile") {
                                        _selectTab("Profile", 5);
                                      }
                                    },
                                    backgroundColor:
                                        (_currentPage == "Blogs") &&
