...
// https://www.bebuzee.com/api/upload_text_story.php
  ...
  late StickerClass mainImageViewData;
  late StickerClass? timeViewData;
  late StickerClass? hashtagViewData;
  late StickerClass? questionsViewData;
  late bool ismusicViewAdd = false;
  late StickerClass? musicViewData;
  late StickerClass? questionsReplyViewData;
  late StickerClass? locationViewData;
  late List<TagsClass> mentionUserList = [];
  late List<String> mentionUserIdList = [];
